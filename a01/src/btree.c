/**
 * 512MB limit in memory
 * 50 file limit on disk
 *
 * keep one tree of pointers in memory
...
int
add_btree(const char *name, const char *email, const int year, const char *country)
{
